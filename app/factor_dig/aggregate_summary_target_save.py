...
short_pair = [
    ...
    ('REGIME_POWDER_KEG', 'FR_HIGH_EXTREME', '30m', 'bottom_3'),
    ('EXIT_FR_EXTREME_HIGH', 'FR_COLD_START', '30m', 'top_1'),
    ('EXIT_FR_EXTREME_HIGH', 'FR_COLD_START', '5m', 'top_1'),
    ('VOLUME_CONFIRM_BREAK', 'FR_COLD_START', '5m', 'bottom_100'),
    ('VOLUME_CONFIRM_BREAK', 'FR_COLD_START', '15m', 'bottom_100'),
]

# 你指定的需要单独提取的特定组合 (进场信号, 出场信号, 周期, 过滤条件)
long_pair = [
    ('VOLUME_CLIMAX_DOWN', 'ENTRY_SILENT_ACCUMULATION', '60m', 'bottom_10'),
    ('VOLUME_CLIMAX_DOWN', 'ENTRY_SILENT_ACCUMULATION', '60m', 'bottom_5'),
    ('EXIT_VOL_EXTREME_DOWN', 'ENTRY_SILENT_ACCUMULATION', '5m', 'bottom_5'),
    ('EXIT_VOL_EXTREME_DOWN', 'ENTRY_SILENT_ACCUMULATION', '15m', 'bottom_5'),
    ('EXIT_FR_ROLL_OVER', 'ENTRY_SILENT_ACCUMULATION', '15m', 'bottom_10'),
    ('EXIT_FR_ROLL_OVER', 'ENTRY_SILENT_ACCUMULATION', '15m', 'top_20'),
    ('FR_ABSOLUTE_HIGH_POS', 'OI_BOTTOM_DIVERGENCE', '15m', 'bottom_20'),
    ('FR_ABSOLUTE_HIGH_POS', 'OI_BOTTOM_DIVERGENCE', '15m', 'top_50'),
    ('FR_HIGH_EXTREME', 'ENTRY_SILENT_ACCUMULATION', '15m', 'top_10'),
    ('FR_HIGH_EXTREME', 'ENTRY_SILENT_ACCUMULATION', '60m', 'bottom_5'),
    ...
    ('EXIT_OI_ROC_PEAK', 'EXIT_MA_DEAD_CROSS', '60m', 'bottom_10'),
    ...
    ('ENTRY_OI_LEAD_MOMENTUM', 'VOL_DOWN_SPIKE', '30m', 'top_5'),
    ('EXIT_SHORT_SURGE_EXTREME', 'FR_LOW_NEG', '30m', 'bottom_3'),
    ...
    ('FR_ROLL_OVER_FROM_HIGH', 'EXIT_DISTRIBUTION_EXHAUSTION_TOP', '5m', 'bottom_50'),
    ('FR_ROLL_OVER_FROM_HIGH', 'EXIT_DISTRIBUTION_EXHAUSTION_TOP', '15m', 'bottom_20'),
]
