...
long_pair = [
    ...
    ("VOLUME_CLIMAX_DOWN", "ENTRY_SILENT_ACCUMULATION", "30m", "bottom_20"),
    ("EXIT_VOL_EXTREME_DOWN", "ENTRY_SILENT_ACCUMULATION", "15m", "bottom_10"),
    ("EXIT_VOL_EXTREME_DOWN", "ENTRY_SILENT_ACCUMULATION", "5m", "bottom_20"),
    ("EXIT_FR_ROLL_OVER", "ENTRY_SILENT_ACCUMULATION", "30m", "top_20"),
    ("EXIT_FR_ROLL_OVER", "ENTRY_SILENT_ACCUMULATION", "15m", "top_10"),
    ("FR_ABSOLUTE_HIGH_POS", "OI_BOTTOM_DIVERGENCE", "15m", "bottom_50"),
    ("FR_ABSOLUTE_HIGH_POS", "OI_BOTTOM_DIVERGENCE", "30m", "bottom_20"),
    ("FR_HIGH_EXTREME", "ENTRY_SILENT_ACCUMULATION", "30m", "top_10"),
    ("FR_HIGH_EXTREME", "ENTRY_SILENT_ACCUMULATION", "30m", "top_20"),
    ("MOM_RECOVERY_FROM_LOW", "FR_RECOVERY_FROM_LOW", "30m", "bottom_10"),
    ("EXIT_OI_ROC_PEAK", "EXIT_MA_DEAD_CROSS", "15m", "bottom_10"),
    ("EXIT_OI_ROC_PEAK", "EXIT_MA_DEAD_CROSS", "5m", "bottom_10"),
    ("OI_NEW_HIGH", "EXIT_MA_DEAD_CROSS", "15m", "bottom_10"),
    ("OI_NEW_HIGH", "EXIT_MA_DEAD_CROSS", "5m", "bottom_10"),
    ("ENTRY_OI_LEAD_MOMENTUM", "VOL_DOWN_SPIKE", "30m", "top_10"),
    ("FR_RECOVERY_FROM_LOW", "STRUCT_RANGE_POSITION_WEAK", "60m", "top_5"),
    ("FR_RECOVERY_FROM_LOW", "STRUCT_RANGE_POSITION_WEAK", "60m", "top_10"),
    ("EXIT_SHORT_SURGE_EXTREME", "FR_LOW_NEG", "60m", "bottom_10"),
    ("EXIT_SHORT_SURGE_EXTREME", "FR_LOW_NEG", "30m", "bottom_10"),
    ("STRUCT_SUPPORT_HOLD", "FR_RECOVERY_FROM_LOW", "30m", "top_5"),
    ("FR_ROLL_OVER_FROM_HIGH", "EXIT_DISTRIBUTION_EXHAUSTION_TOP", "30m", "top_20"),
]
