...
short_pair =  [
    ...
    ('BREAK_RETEST_HOLD_REAL', 'FR_COLD_START', '60m', 'top_1'),
    ('BREAK_RETEST_HOLD_REAL', 'FR_COLD_START', '5m', 'top_1'),
    ...
    ('EXIT_PRICE_NEWHIGH_OI_WEAK', 'ENTRY_FUNDING_COLD_START_TREND', '15m', 'top_1'),
    ('EXIT_PRICE_NEWHIGH_OI_WEAK', 'ENTRY_FUNDING_COLD_START_TREND', '30m', 'top_1'),
    ...
    ('OI_MA_CROSS_UP', 'ENTRY_UNCROWDED_MOMENTUM', '15m', 'bottom_3'),
...
long_pair = [
    ...
    ('ENTRY_TREND_CONFIRM_B', 'FR_VERY_LOW', '5m', 'bottom_3'),
    ('ENTRY_TREND_CONFIRM_B', 'FR_VERY_LOW', '30m', 'bottom_5'),
    ...
    ('STRUCT_SUPPORT_HOLD', 'FR_LOW_NEG', '60m', 'bottom_10'),
    ...
    ('PRICE_CLOSE_CROSS_MA_UP', 'FR_LOW_NEG', '15m', 'top_5'),
    ('EXIT_MULTI_MA_BREAK', 'OI_DROP_EXTREME', '60m', 'top_20'),
    ('EXIT_MULTI_MA_BREAK', 'OI_DROP_EXTREME', '15m', 'top_20'),
    ('EXIT_FR_ROLL_OVER', 'FR_LOW_NEG', '15m', 'top_5'),
    ('EXIT_FR_ROLL_OVER', 'FR_LOW_NEG', '5m', 'top_10'),
    ...
    ('FR_POS_NOT_HOT', 'FR_LOW_NEG', '5m', 'bottom_1'),
    ('FR_HIGH_EXTREME', 'FR_LOW_NEG', '60m', 'bottom_10'),
    ('FR_HIGH_EXTREME', 'FR_LOW_NEG', '15m', 'bottom_10'),
