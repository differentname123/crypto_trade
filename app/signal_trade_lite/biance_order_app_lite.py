...
def run_scheduler():
    ...
    while True:
        try:
            ...
            elif CURRENT_SYMBOL == "XSR_long" or CURRENT_SYMBOL == "fr_short" or CURRENT_SYMBOL == "oi_decay_short" or CURRENT_SYMBOL == "vwap_reclaim_long":
            ...
            if CURRENT_SYMBOL == "cross":
                ...
                signal_df = get_high_fr_bear_div_short_signal_df(exchange, target_time_str, proxy_url=proxy_url,
                                                                 position_cache=position_cache, ledger=ledger)
            elif CURRENT_SYMBOL == "vwap_reclaim_long":
                signal_df = get_vwap_reclaim_long_signal_df(exchange, target_time_str, proxy_url=proxy_url,
                                                            position_cache=position_cache, ledger=ledger)
            else:
