...
def consumer_auto_sync_main(accounts=None):
    ...
    while True:
        try:
            ...
            # 获取裂变池
            global_worth_uids = get_worth_following_list(list(seed_user_names), target_count=10000)
...
if __name__ == "__main__":
    try:
        ...
        t_consumer = threading.Thread(target=consumer_auto_sync_main,
                                      kwargs={"accounts": ["dahao", "nana", "mama", "ruru", "yang", "daniang", "zhouling", "qiqi", "yanglin"]},
